...
@include('navbar')
    ...
    <div id="gradient">
        ...
        <div class="container-md shadow-lg p-3 mb-5 rounded " id="screen">
            <div class="row g-2">
                ...
                <div class="col-6">
                    <div class="p-3 text-end">
                        <p class="text fs-6 text-break"> 
                            <a href="https://github.com/iamAlbano" target="_blank" class="link-light text-decoration-none"> iamAlbano
                        ...
                        <p class="text fs-6 text-break">
                            <a href="https://www.linkedin.com/in/guilhermealbano/" target="_blank" class="link-light text-decoration-none"> guilhermealbano
                        ...
                        <p class="text fs-6 text-break"> oguilhermealbano@gmail.com
    ...
    <div id="inverse-gradient" class="skills">
        ...
        <div class="container-md shadow-lg p-3 rounded second ">
            <div class="row g-2">
    ...
    <div id="gradient" class="portfolio">
        <div class="container-md shadow-lg p-3 mb-5 rounded second ">
            <div class="row g-2 ">
